package archive.main.map_beta;

import archive.main.map_beta.camera.CameraPosition;
import archive.main.map_beta.camera.CameraUpdate;
import archive.main.map_beta.location.LocationSource;
import archive.main.map_beta.marker.Marker;
import archive.main.map_beta.marker.MarkerOptions;

public class AppMap {
    // Adds a marker to this map.
    //
    //The marker's icon is rendered on the map at the archive.main.location Marker.position.
    ...
    // a call to getCameraPosition() returns an intermediate archive.main.location of the camera.
    //
    ...
    // Gets the status of the my-archive.main.location layer.
    //
    //Returns
    //true if the my-archive.main.location layer is enabled; false otherwise.
    ...
    // Replaces the archive.main.location source of the my-archive.main.location layer.
    //
    //Parameters
    //source	A archive.main.location source to use in the my-archive.main.location layer.
    // Set to null to use the default archive.main.location source.
