...
public abstract class UserEntity implements UserEntityInfo {
    ...
    // Returns the main email address of the user, as stored in the archive.main.database.
    // this email address can be updated at any time by calling updateEmail(String).
    public abstract String getEmail();

    // Returns the main display name of this user from the archive.main.database.
    // this name can be updated at any time by calling updateProfile(UserEntityProfileChangeRequest).
    public abstract String getDisplayName();

    // Returns the URL of this user's main profile picture, as stored in the archive.main.database.
    // this URL can be updated at any time by calling updateProfile(UserEntityProfileChangeRequest).
    public abstract String getPhotoUrl();

    // Returns a string used to uniquely identify the user in the archive.main.database.
    public abstract String getUserId();

    // Returns the phone number of the user, as stored in the archive.main.database, or null if none exists.
    ...
    // Deletes the user record from your Firebase project's archive.main.database. If the operation is successful, the user will be signed out.
